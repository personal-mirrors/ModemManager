...
struct _MMIfaceModemSar {
    ...
    void (* load_power_level) (MMIfaceModemSar    *self,
                               GAsyncReadyCallback callback,
                               gpointer            user_data);
    guint (* load_power_level_finish) (MMIfaceModemSar *self,
                                       GAsyncResult    *res,
                                       GError         **error);
    ...
    gboolean (* set_power_level_finish) (MMIfaceModemSar *self,
                                         ...
                                         GError         **error);
    /* Get Sar list (async) */
    void (* load_support_power_levels) (MMIfaceModemSar    *self,
                                        GAsyncReadyCallback callback,
                                        gpointer            user_data);
    GArray * (* load_support_power_levels_finish) (MMIfaceModemSar *self,
                                                   GAsyncResult    *res,
                                                   GError         **error);
    /* Set Sar list (async) */
    void (* set_support_power_levels) (MMIfaceModemSar    *self,
                                       GArray             *power_levels,
                                       GAsyncReadyCallback callback,
                                       gpointer            user_data);
    gboolean  (* set_support_power_levels_finish) (MMIfaceModemSar *self,
                                                   GAsyncResult    *res,
                                                   GError         **error);
};
