...
void mm_bearer_stats_set_uplink_speed         (MMBearerStats *self, guint64 uplink_speed);
void mm_bearer_stats_set_downlink_speed       (MMBearerStats *self, guint64 downlink_speed);
