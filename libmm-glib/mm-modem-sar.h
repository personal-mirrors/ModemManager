...
#define MM_TYPE_MODEM_SAR            (mm_modem_firmware_get_type ())
...
typedef struct _MMModemSarPrivate MMModemSarPrivate;
...
void     mm_modem_sar_set_supported_power_levels        (MMModemSar         *self,
                                                         guint              *levels,
                                                         guint               n_levels,
                                                         GCancellable       *cancellable,
                                                         GAsyncReadyCallback callback,
                                                         gpointer            user_data);
gboolean mm_modem_sar_set_supported_power_levels_finish (MMModemSar   *self,
                                                         GAsyncResult *res,
                                                         GError      **error);

gboolean mm_modem_sar_set_supported_power_levels_sync   (MMModemSar   *self,
                                                         guint        *levels,
                                                         guint         n_levels,
                                                         GCancellable *cancellable,
                                                         GError      **error);
...
gboolean mm_modem_sar_get_supported_power_levels        (MMModemSar *self,
                                                         guint     **levels,
                                                         guint      *n_levels);
gboolean mm_modem_sar_peek_supported_power_levels       (MMModemSar *self,
                                                         guint     **levels,
                                                         guint      *n_levels);
