...
static FieldInfo field_infos[] = {
    ...
    [MMC_F_SIM_SIM_TYPE]                           = { "modem.generic.sim-type",                          "sim type",                 MMC_S_MODEM_SIM,                  },
    [MMC_F_SIM_ESIM_STATUS]                        = { "modem.generic.sim-esim-status",                   "sim esim status",          MMC_S_MODEM_SIM,                  },
    [MMC_F_SIM_SIM_REMOVABILITY]                   = { "modem.generic.sim-removability",                 "sim removability",         MMC_S_MODEM_SIM,                  },
