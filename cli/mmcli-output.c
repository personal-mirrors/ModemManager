...
static FieldInfo field_infos[] = {
    ...
    [MMC_F_SIGNAL_RSSI_THRESHOLD]                  = { "modem.signal.rssi.threshold",                     "rssi threshold",           MMC_S_MODEM_SIGNAL,               },
    [MMC_F_SIGNAL_ERROR_RATE_THRESHOLD]            = { "modem.signal.error.rate.threshold",               "error rate threshold",     MMC_S_MODEM_SIGNAL,               },
